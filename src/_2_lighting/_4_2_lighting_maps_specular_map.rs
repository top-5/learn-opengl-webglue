...
thread_local! {
    static STATE: RefCell<Option<State_2_4_2>> = RefCell::new(None);
}

pub unsafe fn reset_2_4_2() {
    STATE.with(|state| {
...
unsafe fn init_2_4_2() {
    ...
    STATE.with(|state| {
        *state.borrow_mut() = Some(State_2_4_2 {
            lighting_shader,
            lamp_shader,
            cube_vao,
            light_vao,
