...
thread_local! {
    static STATE: RefCell<Option<State_4_1_2>> = RefCell::new(None);
}

unsafe fn reset_4_1_2() {
    STATE.with(|state| {
...
unsafe fn init_4_1_2() {
    ...
    STATE.with(|state| {
        *state.borrow_mut() = Some(State_4_1_2 {
            shader,
            cube_vao: cubeVAO,
            plane_vao: planeVAO,
...
unsafe fn render_4_1_2(camera: &Camera) {
...
pub fn main_4_1_2() {
    ...
    unsafe { render_4_1_2(&Camera::default()); }
}
